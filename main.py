...
from Controller import getCoachTeamsList
...
#     query = f'SELECT `id`, `moveId`, `totalCorrectMoves`, `totalwrongMoves`, `totalDuration`, `performancePercentage`, `teamPerformanceId`, `createdat` FROM `teamperformancedetails` WHERE `isdeleted` = 0'
#     # print("query",query)
...
#         createdat = str(tpd[7])
#         details = TeamPerformanceDetails(id, moveId, totalCorrectMoves, totalwrongMoves, totalDuration,
#                                          performancePercentage, teamPerformanceId, createdat)
#         detailsList.append(details.__dict__)
#
#     teamPerformance = TeamPerformance(detailsList)
#     teamPerformance = teamPerformance.__dict__
#     print("teamPerformanceDetails=",teamPerformance)
#     jsonify(teamPerformance)
#     dumps = json.dumps(teamPerformance)
...
def getCoachTeamsData():
    ...
    coach = Coach(getCoachTeamsList(coachId))
